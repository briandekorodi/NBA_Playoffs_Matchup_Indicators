...
Using regular seaosn four factors to predict playoffs ORtg as a benchmark model.
...
Playoffs_combined <- Playoffs_combined %>%
  select(-c(Result, Series_Pace, Series_eFGpct, Series_ORBpct, Series_TOVpct, Series_FTperFGA, Series_Abs_Net_Rating, Series_PTSperG, Series_Victory_Margin, Series_Net_Rating, `Series_Win/Loss`, Series_Abs_Net_Rating, Losses, Series)) 
...
Run the same model but only taking Finals series, in an attempt to flatten out differences in team quality.
